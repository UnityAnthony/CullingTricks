	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float clampResult738 = clamp( pow( ( (0.5 + (IN.ase_texcoord9.y - 0.0) * (2.0 - 0.5) / (1.0 - 0.0)) * _Gradient ) , _GradientPower ) , -1.0 , 1.0 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float grayscale180 = (tex2DNode2.rgb.r + tex2DNode2.rgb.g + tex2DNode2.rgb.b) / 3;
				float4 temp_cast_1 = (grayscale180).xxxx;
				float clampResult738 = clamp( pow( ( (0.5 + (IN.ase_texcoord5.y - 0.0) * (2.0 - 0.5) / (1.0 - 0.0)) * _Gradient ) , _GradientPower ) , -1.0 , 1.0 );
				float4 lerpResult557 = lerp( _GroundColor , _TopColor , clampResult738);
				float4 GRADIENT558 = lerpResult557;
				float4 blendOpSrc18 = CalculateContrast(0.1,temp_cast_1);
				float4 blendOpDest18 = GRADIENT558;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float grayscale180 = (tex2DNode2.rgb.r + tex2DNode2.rgb.g + tex2DNode2.rgb.b) / 3;
				float4 temp_cast_1 = (grayscale180).xxxx;
				float clampResult738 = clamp( pow( ( (0.5 + (IN.ase_texcoord3.y - 0.0) * (2.0 - 0.5) / (1.0 - 0.0)) * _Gradient ) , _GradientPower ) , -1.0 , 1.0 );
				float4 lerpResult557 = lerp( _GroundColor , _TopColor , clampResult738);
				float4 GRADIENT558 = lerpResult557;
				float4 blendOpSrc18 = CalculateContrast(0.1,temp_cast_1);
				float4 blendOpDest18 = GRADIENT558;
...
Node;AmplifyShaderEditor.RangedFloatNode;302;-3480.34,1528.535;Inherit;False;Property;_WindMovement;Wind Movement;12;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;307;-3161.859,1531.835;Inherit;False;Property;_WindDensity;Wind Density;13;0;Create;True;0;0;0;False;0;False;3.3;1.91;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;310;-2831.992,1556.02;Inherit;False;Property;_WindStrength;Wind Strength;14;0;Create;True;0;0;0;False;0;False;0.3;0.203;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=44CA407470A74AF01E974CD6CAC23EDEE80A6F9E