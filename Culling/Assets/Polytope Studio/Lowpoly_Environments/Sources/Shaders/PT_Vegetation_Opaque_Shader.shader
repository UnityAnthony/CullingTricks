	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float clampResult555 = clamp( pow( ( (0.5 + (IN.ase_texcoord9.y - 0.0) * (2.0 - 0.5) / (1.0 - 0.0)) * _Gradient ) , _GradientPower ) , 0.0 , 1.0 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 tex2DNode2 = tex2D( _BaseTexture, uv_BaseTexture2 );
				float clampResult555 = clamp( pow( ( (0.5 + (IN.ase_texcoord5.y - 0.0) * (2.0 - 0.5) / (1.0 - 0.0)) * _Gradient ) , _GradientPower ) , 0.0 , 1.0 );
				float4 lerpResult557 = lerp( _GroundColor , _TopColor , clampResult555);
				float4 Gradient558 = lerpResult557;
				float grayscale180 = dot(tex2DNode2.rgb, float3(0.299,0.587,0.114));
				float saferPower568 = abs( grayscale180 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 tex2DNode2 = tex2D( _BaseTexture, uv_BaseTexture2 );
				float clampResult555 = clamp( pow( ( (0.5 + (IN.ase_texcoord3.y - 0.0) * (2.0 - 0.5) / (1.0 - 0.0)) * _Gradient ) , _GradientPower ) , 0.0 , 1.0 );
				float4 lerpResult557 = lerp( _GroundColor , _TopColor , clampResult555);
				float4 Gradient558 = lerpResult557;
				float grayscale180 = dot(tex2DNode2.rgb, float3(0.299,0.587,0.114));
				float saferPower568 = abs( grayscale180 );
...
ASEEND*/
//CHKSM=D7420D619E06C97C4B376DCDA65CA5DA5101A12D